# 📊 Clinical Data Specialist | Healthcare Operations to Advanced Data Pipelines

I am a Domain-First Data Analyst and Analytics Engineer. With 13+ years of clinical operations experience, I transition legacy health systems into automated, legally compliant data architectures under India's national ABDM 2.0 and DPDP Act 2023 mandates.

## 🛠️ Core Tech Stack & Focus
- **Languages & Frameworks:** Python (Polars, Pandas), SQL, FastAPI, Streamlit, LangChain
- **Databases & Storage:** SQLite, MongoDB, Relational Schemas, Hybrid Relational-JSON Modeling
- **Domain Standards:** ABDM 2.0 Interoperability, HL7, FHIR R5 Schemas, DPDP Act 2023 Compliance
- **Focus Areas:** Real-Time Webhook Ingress, Automated Transaction Auditing, Local Text-to-SQL RAG Pipelines
...
- **Governance System:** Integrated data governance suite equipped with an interactive, Rule 8.3 cascading cryptographic "Kill-Switch" for instant DPDP Act compliance demonstrations.

---

## 🎓 Academic & Regulatory Trust Anchors
- **BCA (Computer Applications):** Final Semester, University of Mysore
- **IIT Kharagpur:** Medical Law & Ethics (Health-Tech Regulatory Compliance)
- **IIT Guwahati:** Generative AI & LLM Workflows (Information Retrieval Logic)

## 📫 Connect with me
- **LinkedIn:** https://www.linkedin.com/in/nisar-ahmed-8440763a3
